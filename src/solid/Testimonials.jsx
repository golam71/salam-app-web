              ...
              <ul className="space-y-6 sm:space-y-8">
                {column.map((testimonial, testimonialIndex) => (
                  <li key={testimonialIndex}>
                    <figure className="relative rounded-2xl  p-6 shadow-xl shadow-slate-900 border-2 border-aquamarine">
                      <svg
                        aria-hidden="true"
                        width={105}
                        height={78}
                        className="absolute top-6 opacity-5 left-6 fill-slate-100"
                      >
